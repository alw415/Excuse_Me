...
public class teacher_register extends AppCompatActivity {
    ...
    String reg_url = "http://proj-309-ab-1.cs.iastate.edu/ExcuseME_OFFICIAL/teacherLogin/registerTEACHER.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(teacher_register.this);
            ...
            public void onClick(View v) {
                ...
                if (name.equals("") || email.equals("") || username.equals("") || password.equals("") || conpass.equals("")) {
                    ...
                    if (!password.equals(conpass)) {
                        ...
                        _MySingleton.getInstance(teacher_register.this).addToRequestQueue(stringRequest);
                    }
