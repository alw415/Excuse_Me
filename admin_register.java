...
public class admin_register extends AppCompatActivity {
    ...
    String reg_url = "http://proj-309-ab-1.cs.iastate.edu/ExcuseME_OFFICIAL/adminLogin/registerADMIN.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(admin_register.this);
        ...
        reg_bn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.equals("") || email.equals("") || username.equals("") || password.equals("") || conpass.equals("")) {
                    ...
                    //Passwords Match move forward with registration
                    else {
                        ...
                        _MySingleton.getInstance(admin_register.this).addToRequestQueue(stringRequest);
                    }
